...
const settings = {
  particles: {
    length: 10000,    // Số lượng particle tối đa
    ...
    size: 8,          // Kích thước particle cơ bản (dùng để tạo ảnh trái tim)
  },
  heart: {
...
function createHeartImage() {
  ...
  ctx.closePath()
  // Sử dụng gradient radial cho hiệu ứng lung linh
...
const HeartCanvas = () => {
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      // Sinh particle từ các điểm trên đường cong trái tim (áp dụng hiệu ứng nhịp đập)
      ...
      // Vẽ thêm viền trái tim pulsating
      context.save()
